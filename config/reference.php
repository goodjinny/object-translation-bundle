 ...
 *     },
 * }
 * @psalm-type GoodjinnyObjectTranslationConfig = array{
 *     translation_class: scalar|null|Param, // The class name of your Translation entity.
 *     cache?: bool|array{ // Cache settings for object translations.
 *         enabled?: bool|Param, // Default: true
 *         pool?: scalar|null|Param, // The cache pool to use for storing object translations. // Default: "cache.app"
 *         ttl?: int|Param, // The time-to-live for cached translations, in seconds. null for no expiration. // Default: null
 *     },
 * }
 ...
 *     goodjinny_object_translation?: GoodjinnyObjectTranslationConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
